...
public class Analysis implements Serializable {
	...
	public Analysis(int anl_no, int mem_no, int pic_no, String pic_add, int pic_count, int good_count, int rep_count,
			String anl_word, Timestamp anl_date, int anl_count) {
		super();
		this.anl_no = anl_no;
		this.mem_no = mem_no;
		this.pic_no = pic_no;
	...
	public String toString() {
		return "Analysis [anl_no=" + anl_no + ", mem_no=" + mem_no + ", pic_no=" + pic_no + ", pic_add=" + pic_add
				+ ", pic_count=" + pic_count + ", good_count=" + good_count + ", rep_count=" + rep_count + ", anl_word="
				+ anl_word + ", anl_date=" + anl_date + ", anl_count=" + anl_count + "]";
	}
