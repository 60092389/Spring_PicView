...
public class Picture implements Serializable{
	...
	private int good_count;//좋아요횟수
	private String pic_add;//사진이미지경로
	private String pic_album_no;//소속앨범
	...
	public String getPic_album_no() {
		return pic_album_no;
	}
	public void setPic_album_no(String pic_album_no) {
		this.pic_album_no = pic_album_no;
	}
	...
	public String toString() {
		return "Picture [pic_title=" + pic_title + ", mem_no=" + mem_no + ", category_no=" + category_no + ", tag_name="
				+ tag_name + ", pic_content=" + pic_content + ", pic_count=" + pic_count + ", good_count=" + good_count
				+ ", pic_add=" + pic_add + ", pic_album_no=" + pic_album_no + ", pic_open=" + pic_open + ", pic_color="
				+ pic_color + "pic_location=" + pic_location + "]";
	}
