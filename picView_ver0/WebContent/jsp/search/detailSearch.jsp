...
<script type="text/javascript">
	...
	function tagSearch() {
		if(check == 'member'){
			...
			html +=	"<a id='view-more-member' class='view-more-link' data-track='search-viewall-user' "+
			"data-rapid_p='47'></a>회원님의 사진</h5>";
			...
			$('.color-swatch').click(function() {
				...
				if(colorList.size()==1){
					...
					var html = "<div class='main search-contacts-results'>";
			 		html += "<div class='view search-photos-yours-view'>";
			 	   	html += "<h5 class='search-results-header' id='explan'>";
					html +=	"<a class='view-more-link' data-track='search-viewall-user' "+
					"data-rapid_p='47'></a>회원님의 사진</h5>";
			 ...
			 $.getJSON("memColor",{search:encodeURIComponent(search2),tag:encodeURIComponent(tag)},
					 ...
					 if(data==0){
					  ...
					  $.each(data,function(index,pic){
						    ...
						    html += "<div class='view photo-list-photo-view awake' style='background-image:url(../../upload/"
							+ pic.pic_add+ ")'>";
							html += "<div class='interaction-view'>";
							html += "<div class='photo-list-photo-interaction'>";
							html += "<a class='overlay' href='../../jsp/basic/picDetail?pic_no="+pic.pic_no+"'>"+
			 ...
			 $.getJSON("searchFollow",{search:encodeURIComponent(search),tag:encodeURIComponent(tag)},function(data){
				...
				console.log('생성 후 list 사이즈'+colorList.size());
					...
					html3 += "<div class='view search-photos-yours-view' style='height:268px'>";
				   	html3 += "<h5 class='search-results-header' id='explan'>";
					html3 +=	"<a class='view-more-link' data-track='search-viewall-user' "+
			...
			<div class="search-subnav-sizing fluid-centered">
				<div class="search-subnav-content">
					<ul class="links">
						...
						<a class="peopleLink">
								<div class="title" id="explan2">사람</div></a>
						</li>
					</ul>
					<ul class="tools"> </ul>
				</div>
				      ...
				      <div class="view search-search-in-picker-view requiredToShowOnServer">
						<p  class="option-header">검색:</p>
							<ul class="search-in-list">
								<li class="search-in-button selected" data-tooltip-prefer-bottom="true" 
