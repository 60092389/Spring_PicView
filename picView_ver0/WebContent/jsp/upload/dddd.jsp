...
<title>Insert title here</title>
          ...
          $("#posY").text(oEvent.point.y);
            ...
            function getPosList(){
             ...
             $.ajax({
              ...
              , type : "GET"
              , data : "key=63a683902e9d30dc3c7226cb1e57599f&coord=latlng&query=" + addr
              , dataType : "xml"
        ...
        <script type="text/javascript" src="http://openapi.map.naver.com/openapi/naverMap.naver?ver=2.0&key=63a683902e9d30dc3c7226cb1e57599f"></script>
        <style>
